    ...
    public class DataAccess : IDisposable
    {
        ...
        public DataAccess(ref CustomParameters ParmsCustom)
        {
                ...
                _parmsCustom.Password.Length != 0)
            {
                ...
                //_DSN = "BPAT_PKG.CONSECO.COM:1521/BPAT";
                //_DBUser = "ia_user";
                //_DBPass = "ia_user";
        ...
        public Dictionary<string, string> getMDWMappings()
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_input_source",
                  BatchDetail.InputSource, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public void updateFaxXref()
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_faxid",
                   DocumentDetail.FaxID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_fax_key",
                   DocumentDetail.FaxKey, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
        ...
        public void updateImportXref()
        {
            try
            {
                ...
                DBUtilities.CreateAndAddParameter("p_in_action_indicator",
                   "U", OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_app_name",
                   "CNO.BPA.MDWAUDIT", OracleDbType.Varchar2, ParameterDirection.Input, cmd);
                DBUtilities.CreateAndAddParameter("p_in_machine_name",
                ...
                DBUtilities.CreateAndAddParameter("p_in_guid",
                   DocumentDetail.dGUID, OracleDbType.Varchar2, ParameterDirection.Input, cmd);
